...
static const LPBYTE  byRSExp[] = {NULL,      NULL,      NULL,      NULL,      NULL,      NULL,      NULL,      (const LPBYTE)byRSExp7,  NULL,      NULL,
							(const LPBYTE)byRSExp10, NULL,      NULL,      (const LPBYTE)byRSExp13, NULL,      (const LPBYTE)byRSExp15, (const LPBYTE)byRSExp16, (const LPBYTE)byRSExp17, (const LPBYTE)byRSExp18, NULL,
							(const LPBYTE)byRSExp20, NULL,     (const LPBYTE) byRSExp22, NULL,     (const LPBYTE) byRSExp24, NULL,     (const LPBYTE) byRSExp26, NULL,   (const LPBYTE)   byRSExp28, NULL,
							(const LPBYTE)byRSExp30, NULL,     (const LPBYTE) byRSExp32, NULL,     (const LPBYTE) byRSExp34, NULL,   (const LPBYTE)   byRSExp36, NULL,    (const LPBYTE)  byRSExp38, NULL,
							(const LPBYTE)byRSExp40, NULL,     (const LPBYTE) byRSExp42, NULL,     (const LPBYTE) byRSExp44, NULL,   (const LPBYTE)   byRSExp46, NULL,      (const LPBYTE)byRSExp48, NULL,
							(const LPBYTE)byRSExp50, NULL,     (const LPBYTE) byRSExp52, NULL,     (const LPBYTE) byRSExp54, NULL,   (const LPBYTE)   byRSExp56, NULL,     (const LPBYTE) byRSExp58, NULL,
							(const LPBYTE)byRSExp60, NULL,     (const LPBYTE) byRSExp62, NULL,     (const LPBYTE) byRSExp64, NULL,    (const LPBYTE)  byRSExp66, NULL,     (const LPBYTE) byRSExp68};
